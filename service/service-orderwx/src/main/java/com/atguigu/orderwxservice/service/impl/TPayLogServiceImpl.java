...
import com.atguigu.orderwxservice.entity.HttpClientWX;
import com.atguigu.orderwxservice.entity.TOrder;
import com.atguigu.orderwxservice.entity.TPayLog;
import com.atguigu.orderwxservice.mapper.TPayLogMapper;
import com.atguigu.orderwxservice.service.TOrderService;
import com.atguigu.orderwxservice.service.TPayLogService;
...
public class TPayLogServiceImpl extends ServiceImpl<TPayLogMapper, TPayLog> implements TPayLogService {
    ...
    public Map queryPayStatus(String orderNo) {
        try {
            ...
            //2、设置请求
            HttpClientWX client = new HttpClientWX("https://api.mch.weixin.qq.com/pay/orderquery");
            client.setXmlParam(WXPayUtil.generateSignedXml(m, "T6m9iK73b0kn9g5v426MKfHQH7X8rKwb"));
            client.setHttps(true);
            client.post();
            //3、返回第三方的数据
